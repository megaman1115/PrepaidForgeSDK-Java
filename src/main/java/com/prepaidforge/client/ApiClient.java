...
package com.prepaidforge.client;
...
import com.prepaidforge.client.auth.Authentication;
import com.prepaidforge.client.auth.HttpBasicAuth;
import com.prepaidforge.client.auth.HttpBearerAuth;
import com.prepaidforge.client.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "http://localhost:8080/api-1.0-SNAPSHOT/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("PrepaidforgeAPIToken", new ApiKeyAuth("header", "X-PrepaidForge-Api-Token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8080/api-1.0-SNAPSHOT/v1
